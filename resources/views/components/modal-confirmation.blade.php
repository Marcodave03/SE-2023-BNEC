      ...
      <div class="modal-dialog modal-dialog-centered" style="max-width: 28rem">
          <div class="modal-content border-0 shadow py-3">
              ...
              <div class="modal-footer m-auto border-0">
                  <button type="button" class="btn-outline-pink py-2 px-5" data-bs-dismiss="modal">
                      Cancel
                  </button>
                  @if ($action == 'destroy')
                      <form method="POST" action="{{ route($name . '.' . $action, $model) }}">
                          ...
                          <button type="submit" class="btn-pink py-2 px-5">Continue</button>
                      </form>
                  @else
                      <a href="{{ route($name . '.' . $action, $model) }}" class="btn-pink py-2 px-5">
                          Continue
                      </a>
                  @endif
              </div>
